 ...
 */
@Singleton
public class WorkspaceFSStorageCleanerImpl implements WorkspaceFSStorageCleaner {

    private static final Logger LOG = LoggerFactory.getLogger(WorkspaceFSStorageCleanerImpl.class);
